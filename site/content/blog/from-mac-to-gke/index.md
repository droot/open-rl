...
date: 2026-08-19
authors: ["OpenRL team"]
summary: "OpenRL is a self-hosted, open-source API that makes this simple."
tags: ["tutorial", "gke"]
draft: false
---
...
[OpenRL](https://github.com/gke-labs/open-rl) is a self-hosted, open-source API that makes this simple. Write your training loop once using the Tinker SDK, run it on your Mac to iterate fast, then point it at a GKE cluster when you're ready to scale. Same code, any backend.
...
<p align="center">
  <img src="training-loop.svg" alt="Tinker Training Loop: 4 Primitives" width="100%">
</p>
...
<p align="center">
  <img src="training-dashboard.svg" alt="Training Dashboard: Loss and Similarity over 25 steps" width="100%">
</p>
...
<p align="center">
  <img src="local-to-cloud.svg" alt="Local to Cloud Architecture" width="100%">
</p>
